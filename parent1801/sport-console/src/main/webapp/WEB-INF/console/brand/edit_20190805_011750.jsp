...
<div class="body-box" style="float:right">
	<form id="jvForm" action="editBrand.do" method="post" enctype="multipart/form-data">
	<input type="hidden" value="${brand.id }" name="id"></input>
		<table cellspacing="1" cellpadding="2" width="100%" border="0" class="pn-ftable">
			...
			<input type="hidden" name="name0" value="${name }"/>
			<input type="hidden" name="isDisplay0" value="${isDisplay }"/>
